module wb_intercon (
  ...
  wb_mux #(
      .num_slaves(6),
      .MATCH_ADDR({
        32'h20000200, // SPI ADDR
        32'h80040000, // DMEM ADDR
        32'h80000000, // IMEM ADDR
        32'h20000100, // GPIO ADDR
        32'h20000000, // UART ADDR
        32'h20000c00  // CLINT ADDR
      }),
      .MATCH_MASK({
        32'hffffff00, // SPI ADDR MASK
        32'hfffc0000, // DMEM ADDR MASK
        32'hfffc0000, // IMEM ADDR MASK
        32'hffffff00, // GPIO ADDR MASK
        32'hffffff00, // UART ADDR MASK
        32'hffffff00  // CLINT ADDR MASK
      })
  ) wb_mux_io (
      .wb_clk_i(wb_clk_i),
      .wb_rst_i(wb_rst_i),
      ...
      .wbs_we_o({
        wb_spi_flash_we_o, wb_dmem_we_o, wb_imem_we_o, wb_gpio_we_o, wb_uart_we_o, wb_clint_we_o
      }),
      .wbs_cyc_o({
        wb_spi_flash_cyc_o,
        wb_dmem_cyc_o,
